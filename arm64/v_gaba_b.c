...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 GABAb_S /Users/vartanarakelian/Documents/GitHub/MS_ReflexCircuit/v_gaba_b.mod\n");
...
{
 { error =  bindkin();
 if(error){fprintf(stderr,"at line 146 in file v_gaba_b.mod:\n	SOLVE bindkin METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/vartanarakelian/Documents/GitHub/MS_ReflexCircuit/v_gaba_b.mod";
static const char* nmodl_file_text = 
